            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row gap-16 items-center mb-16">
                    ...
                    >
                        ...
                        <h3 className="section-title text-game-dark mb-8 uppercase italic tracking-tighter">
                            LIDERANDO A REVOLUÇÃO <span className="text-game-primary">DIGITAL EM ANGOLA</span>
                        </h3>
                        <div className="space-y-6 text-game-dark/70 text-lg leading-relaxed mb-8">
                            <p>
                            ...
                            <p className="bg-game-primary/5 p-6 border-l-4 border-game-primary">
                        ...
                        <div className="flex items-center gap-12">
                            <div className="flex flex-col">
                                <span className="text-4xl font-tech font-black text-game-dark">100%</span>
                                <span className="text-[10px] text-game-dark/40 uppercase tracking-widest font-bold">Angolana</span>
                            </div>
                            <div className="h-12 w-[1px] bg-gray-200"></div>
                            <div className="flex flex-col">
                                <span className="text-4xl font-tech font-black text-game-primary">+Impacto</span>
                                <span className="text-[10px] text-game-dark/40 uppercase tracking-widest font-bold">Social</span>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="relative z-10 border-2 border-game-dark p-2 bg-white rotate-2 hover:rotate-0 transition-transform duration-500">
                            <img src="/assets/game_construct.jpg" alt="GameTech Development Environment" className="w-full h-[500px] object-cover" />
                        </div>
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-game-primary/5 -z-10 rounded-full blur-3xl"></div>
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-t border-gray-100">
                    {[
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="p-12 border-r border-gray-100 last:border-r-0 hover:bg-game-primary/5 transition-colors group"
                        >
                            <div className="mb-8 text-game-primary group-hover:scale-110 transition-transform">
                                {card.icon}
                            </div>
                            <h4 className="text-xl font-tech font-black text-game-dark mb-4 uppercase italic tracking-tighter">{card.title}</h4>
                            <p className="text-game-dark/60 leading-relaxed">{card.desc}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
